...
# print(f"Size: ({term.width}, {term.height})")
# print(f"N colors: {term.number_of_colors}")
# print(term.green_reverse("ALL SYSTEMS GO"))
# print(term.white_on_firebrick3("SYSTEM OFFLINE"))
# print(
#     f"{term.yellow}Yellow is brown, {term.bright_yellow}"
...
# print(term.underline_green_on_yellow("They live! In sewers!"))
